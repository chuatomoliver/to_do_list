...
class _AddEditNotePageState extends State<AddEditNotePage> {
  ...
  /// function update for Update Page
  Future updateNote() async {
    await _noteProvider.addOrUpdate(
        title, description, createdTime, EditMode.update, widget.note?.id);
  }

  /// function add for Update Page
  Future addNote() async {
    await _noteProvider.addOrUpdate(
        title, description, createdTime, EditMode.add);
  }
